...
export const footerContainerVariants = cva('mx-auto w-full', {
  variants: {
    size: {
...
export const footerLinkVariants = cva('transition-colors', {
  variants: {
    variant: {
...
export const footerHeadingVariants = cva('font-semibold', {
  variants: {
    variant: {
  ...
  'inline-flex items-center justify-center font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-2',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-white text-gray-900 shadow-xs ring-1 ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-white dark:ring-white/20 dark:hover:bg-white/20',
...
export const footerInputVariants = cva(
  'w-full min-w-0 rounded-md text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 dark:text-white dark:outline-gray-700 dark:placeholder:text-gray-500',
  {
    variants: {
      variant: {
        default:
          'bg-white dark:bg-white/5 focus-visible:outline-indigo-600 dark:focus-visible:outline-indigo-500',
        filled:
          'bg-gray-50 dark:bg-gray-800 focus-visible:outline-indigo-600 dark:focus-visible:outline-indigo-500',
      },
      size: {
...
export const footerDividerVariants = cva('border-t', {
  variants: {
    variant: {
