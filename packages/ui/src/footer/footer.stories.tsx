...
const meta: Meta<typeof Footer> = {
  ...
  argTypes: {
    ...
    layout: {
      control: { type: 'select' },
      options: ['simple', 'centered', 'columns', 'newsletter', 'cta', 'mission'],
    },
    size: {
      control: { type: 'select' },
      options: ['sm', 'md', 'lg'],
    ...
    <Footer variant="default" size="md">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <FooterSection title="Custom Section">
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              This is a custom footer section using the composition pattern.
            </p>
          </FooterSection>
          <div className="mt-8 xl:mt-0">
            <FooterSection title="Quick Links">
              <FooterLinks
                links={[
                  { name: 'Custom Link 1', href: '#' },
                  { name: 'Custom Link 2', href: '#' },
                  { name: 'Custom Link 3', href: '#' },
                ]}
              />
            </FooterSection>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-800">
          <FooterSocial links={socialLinks} className="justify-center" />
          <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
            © 2024 Custom Footer. All rights reserved.
          </p>
        </div>
      </div>
    </Footer>
